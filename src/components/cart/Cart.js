...
const Cart = () => {
  ...
  const removeCartItemsFromCart = (id) => {
  ...
  return (
    <>
      {/* condditional rendering based on cartItems */}
      {cartItems.length === 0 ? (
        <h2 className="mt5">Your Cart is empty</h2>
      ) : (
        <>
          {/* Display the numberof items in the cart */}
          <h2 className="mt-5">
                    ...
                    <div className="row">
                      ...
                      <div className="col-4 col-lg-1 mt-4 mt-lg-0">
                        <i
                          ...
                          onClick={() => removeCartItemsFromCart(item.fooditem)}
                        ></i>
                      </div>
                    </div>
                  </div>
