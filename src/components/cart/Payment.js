...
const Payment = () => {
  ...
  const orderInfo = JSON.parse(sessionStorage.getItem("oderInfo"));
  if (orderInfo) {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      paymentData.description = "Payment for Food item is been made...";
